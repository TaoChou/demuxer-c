...
/**
 * list_is_last - tests whether @p list is the last entry in list @p head
 ...
 *
 * This helper moves the initial part of @p head, up to and
 * including @p entry, from @p head to @p list. You should
 * pass on @p entry an element you know is on @p head. @p list
